...
Binds the selected certificate to 0.0.0.0:8080
.Example
...
.Parameter Port
An integer matching the https port of the binding to list. The default is 8080.
...
Lists bindings for 0.0.0.0:8080, if any
.Example
...
Removes the binding to 0.0.0.0:8080, if it exists
.Example
